...
uplink-slayer-coat-name = Плащ S.L.A.Y.E.R.
uplink-slayer-coat-desc = Плащ S.L.A.Y.E.R. был специально разработан для ношения поверх плеч и защищает своего носителя от взрывов! Поставляется с постоянной трансляцией на камерные роутеры Nanotrasen, так что о скрытности оперативнику, носящему его, придётся забыть!
